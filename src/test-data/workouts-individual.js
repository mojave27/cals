export const workout_3_exGroups = {
  sets: [
    {
      exerciseGroups: [
        {
...
// ---------------------------------------------------------------------------
export const workout_1_exGroup = {
  sets: [
    {
      exerciseGroups: [
        {
  ...
  description: 'Kingsbury Phase 2, Weeks 1-4, DAY-3',
  id: '1d3794b0-5911-11eb-9a67-c9672112f587',
  name: 'Kingsbury P2-G1-D3',
}
// ---------------------------------------------------------------------------
export const workout_2_exGroups = {
  sets: [
    {
      exerciseGroups: [
        {
    ...
    },
    {
      exercises: [
        ...
        },
        {
          name: 'OHP, ez bar',
          reps: '6x8',
          id: '1148ea70-5c5c-11eb-aed7-dbd3c43aad1f',
          type: 'compound',
        },
      ],
      id: 1,
  ...
  description: 'OHP',
  id: 'ee9c1d80-5c5b-11eb-8667-e577b7414135',
  name: '6x8 SHOULDERS - C',
}

// --------------------------------------------------------------------------------------
export const workout_extra_data = {
  sets: [
    {
      exerciseGroups: [
        {
...
// --------------------------------------------------------------------------------------
export const workout_4_exGroups = {
  sets: [
    {
      exerciseGroups: [
        {
...
export const workout_empty = {
  ...
  exerciseGroups: [],
  description: 'empty workout description',
  id: '8',
  name: 'empty workout name',
}

export const workout_no_sets = {
  exerciseGroups: [
    {
      exercises: [
        {
...
export const real_workout_2 = {
  name: 'MIX - U1',
  description: 'mix of 5x5 and 20s',
  id: '5ad938c0-9adc-11eb-a903-f5a7a3d8c05d',
  sets: [
    {
      exerciseGroups: [
        {
          exercises: [
            { name: 'dips', weight: '60', id: '1', reps: '5' },
            { name: 'row, cable (narrow)', weight: '110', id: '24', reps: '5' },
          ],
          id: 0,
        },
        {
    ...
    },
    {
      exerciseGroups: [
        {
          exercises: [
            { weight: '60', id: '1', reps: '5' },
            { weight: '115', id: '24', reps: '5' },
          ],
          id: 0,
        },
        {
